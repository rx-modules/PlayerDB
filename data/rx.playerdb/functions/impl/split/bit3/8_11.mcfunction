...
execute if score $bit rx.temp matches 8 run data remove rx:temp playerdb.filtered3
...
execute if score $bit rx.temp matches 9 run data remove rx:temp playerdb.filtered3
...
execute if score $bit rx.temp matches 10 run data remove rx:temp playerdb.filtered3
...
execute if score $bit rx.temp matches 11 run data remove rx:temp playerdb.filtered3