...
execute if score $bit rx.temp matches 0 run data remove rx:temp playerdb.filtered2
...
execute if score $bit rx.temp matches 1 run data remove rx:temp playerdb.filtered2
...
execute if score $bit rx.temp matches 2 run data remove rx:temp playerdb.filtered2
...
execute if score $bit rx.temp matches 3 run data remove rx:temp playerdb.filtered2