...
function rx.playerdb:impl/split/bit1/0_63
data modify storage rx:temp playerdb.leftover append from storage rx:temp playerdb.filtered1[]
...
execute if score $size rx.temp matches 2.. run function rx.playerdb:impl/split/bit2
