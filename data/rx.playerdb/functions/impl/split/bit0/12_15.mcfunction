...
execute if score $bit rx.temp matches 12 run data remove rx:temp playerdb.filtered0
...
execute if score $bit rx.temp matches 13 run data remove rx:temp playerdb.filtered0
...
execute if score $bit rx.temp matches 14 run data remove rx:temp playerdb.filtered0
...
execute if score $bit rx.temp matches 15 run data remove rx:temp playerdb.filtered0