...
execute if score $bit rx.temp matches 60 run data remove rx:temp playerdb.filtered0
...
execute if score $bit rx.temp matches 61 run data remove rx:temp playerdb.filtered0
...
execute if score $bit rx.temp matches 62 run data remove rx:temp playerdb.filtered0
...
execute if score $bit rx.temp matches 63 run data remove rx:temp playerdb.filtered0