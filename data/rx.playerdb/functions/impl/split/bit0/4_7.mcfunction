...
execute if score $bit rx.temp matches 4 run data remove rx:temp playerdb.filtered0
...
execute if score $bit rx.temp matches 5 run data remove rx:temp playerdb.filtered0
...
execute if score $bit rx.temp matches 6 run data remove rx:temp playerdb.filtered0
...
execute if score $bit rx.temp matches 7 run data remove rx:temp playerdb.filtered0