...
BIT = (
    ...
    'execute unless score $bit rx.temp matches 0 if data storage rx:global playerdb.uuid[{bit@:0b}] run data modify storage rx:global playerdb.uuid[{bit@:0b}].selected set value 0b\n'  # noqa: E501
